...
import (
	...
	_ "Dana/plugins/parsers/all"
	_ "Dana/plugins/serializers/all"

	"Dana/internal/goplugin"
	_ "Dana/plugins/aggregators/all"
	_ "Dana/plugins/inputs/all"
	_ "Dana/plugins/outputs/all"
	_ "Dana/plugins/processors/all"
