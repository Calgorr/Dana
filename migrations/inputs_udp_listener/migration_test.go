...
import (
	...
	"Dana/config"
	_ "Dana/migrations/inputs_udp_listener" // register migration
	_ "Dana/plugins/inputs/socket_listener" // register plugin
	_ "Dana/plugins/parsers/all"            // register parsers
)
