...
import (
	...
	"Dana"
	inputs "Dana/plugins/inputs/prometheus"
	"Dana/plugins/serializers/prometheus"
	"Dana/testutil"
)
...
`),
		},
		{
			...
			expected: []byte(`
# HELP cpu_usage_idle Dana2 collected metric
