...
func (s commitCommentEvent) NewMetric() Dana.Metric {
...
func (s createEvent) NewMetric() Dana.Metric {
	event := "create"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s deleteEvent) NewMetric() Dana.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s deploymentEvent) NewMetric() Dana.Metric {
	event := "deployment"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s deploymentStatusEvent) NewMetric() Dana.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s forkEvent) NewMetric() Dana.Metric {
	event := "fork"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s gollumEvent) NewMetric() Dana.Metric {
	event := "gollum"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s issueCommentEvent) NewMetric() Dana.Metric {
	event := "issue_comment"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s issuesEvent) NewMetric() Dana.Metric {
	event := "issue"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s memberEvent) NewMetric() Dana.Metric {
	event := "member"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s membershipEvent) NewMetric() Dana.Metric {
	event := "membership"
	t := map[string]string{
		"event":  event,
		"user":   s.Sender.User,
...
func (s pageBuildEvent) NewMetric() Dana.Metric {
	event := "page_build"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s publicEvent) NewMetric() Dana.Metric {
	event := "public"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s pullRequestEvent) NewMetric() Dana.Metric {
	event := "pull_request"
	t := map[string]string{
		"event":      event,
		"action":     s.Action,
...
func (s pullRequestReviewCommentEvent) NewMetric() Dana.Metric {
...
func (s pushEvent) NewMetric() Dana.Metric {
	event := "push"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s releaseEvent) NewMetric() Dana.Metric {
	event := "release"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s repositoryEvent) NewMetric() Dana.Metric {
	event := "repository"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s statusEvent) NewMetric() Dana.Metric {
	event := "status"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s teamAddEvent) NewMetric() Dana.Metric {
	event := "team_add"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s watchEvent) NewMetric() Dana.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
