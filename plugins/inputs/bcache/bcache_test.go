...
func TestBcacheGeneratesMetrics(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "Dana2-bcache")
	require.NoError(t, err)
	defer os.RemoveAll(tmpDir)

	testBcachePath := tmpDir + "/Dana2-bcache/sys/fs/bcache"
	testBcacheUUIDPath := testBcachePath + "/663955a3-765a-4737-a9fd-8250a7a78411"
	testBcacheDevPath := tmpDir + "/Dana2/sys/devices/virtual/block/bcache0"
	testBcacheBackingDevPath := tmpDir + "/Dana2/sys/devices/virtual/block/md10"
