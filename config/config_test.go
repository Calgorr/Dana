...
import (
	...
	_ "Dana/plugins/parsers/all" // Blank import to have all parsers for testing
	"Dana/plugins/parsers/json"
	"Dana/plugins/parsers/json_v2"
	"Dana/plugins/processors"
	"Dana/plugins/serializers"
	_ "Dana/plugins/serializers/all" // Blank import to have all serializers for testing
	serializers_prometheus "Dana/plugins/serializers/prometheus"
	"Dana/testutil"
)
